...
export const CHARACTERS = [
  // ── Starter Pokémon ──────────────────────────────────────────────────────────
  { id: 'Pikachu',    label: 'Pikachu',    targetHeight: 1.2 },
  { id: 'Charmander', label: 'Charmander', targetHeight: 1.2 },
  { id: 'Bulbasaur',  label: 'Bulbasaur',  targetHeight: 1.2 },
  { id: 'Squirtle',   label: 'Squirtle',   targetHeight: 1.2 },
  { id: 'Eevee',      label: 'Eevee',      targetHeight: 1.0 },
  // ── Legendary / Rare ─────────────────────────────────────────────────────────
  { id: 'Mew',        label: 'Mew',        targetHeight: 1.0 },
  { id: 'Snorlax',    label: 'Snorlax',    targetHeight: 1.4 },
  // ── Classic Pokémon ──────────────────────────────────────────────────────────
  { id: 'Haunter',    label: 'Haunter',    targetHeight: 1.2 },
  { id: 'Jigglypuff', label: 'Jigglypuff', targetHeight: 1.0 },
  { id: 'Magikarp',   label: 'Magikarp',   targetHeight: 1.0 },
  { id: 'Oddish',     label: 'Oddish',     targetHeight: 1.0 },
  { id: 'Poliwag',    label: 'Poliwag',    targetHeight: 1.0 },
  { id: 'Bellsprout', label: 'Bellsprout', targetHeight: 1.2 },
  { id: 'Magnemite',  label: 'Magnemite',  targetHeight: 1.0 },
  { id: 'Cubone',     label: 'Cubone',     targetHeight: 1.1 },
  { id: 'Dratini',    label: 'Dratini',    targetHeight: 1.2 },
  { id: 'Exeggutor',  label: 'Exeggutor',  targetHeight: 1.6 },
  { id: 'Weedle',     label: 'Weedle',     targetHeight: 0.9 },
  { id: 'Abra',       label: 'Abra',       targetHeight: 1.2 },
  { id: 'Diglett',    label: 'Diglett',    targetHeight: 0.8 },
  { id: 'Porygon',    label: 'Porygon',    targetHeight: 1.1 },
  // ── Gen II Pokémon ────────────────────────────────────────────────────────────
  { id: 'Marill',     label: 'Marill',     targetHeight: 1.0 },
  { id: 'Sudowoodo',  label: 'Sudowoodo',  targetHeight: 1.3 },
  { id: 'Glalie',     label: 'Glalie',     targetHeight: 1.2 },
  // ── Items ─────────────────────────────────────────────────────────────────────
  { id: 'Pokeball',   label: 'Pokéball',   targetHeight: 0.9, noVisitor: true },
  { id: 'PokeBall2',  label: 'Pokéball II',targetHeight: 0.9, noVisitor: true },
]
