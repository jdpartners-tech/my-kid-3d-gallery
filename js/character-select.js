...
export const CHARACTERS = [
  // ── Starter Pokémon ──────────────────────────────────────────────────────────
  { id: 'Pikachu',    label: 'Pikachu',    targetHeight: 1.2, facingOffset: 0 },
  { id: 'Charmander', label: 'Charmander', targetHeight: 1.2, facingOffset: 0 },
  { id: 'Bulbasaur',  label: 'Bulbasaur',  targetHeight: 1.2, facingOffset: 0 },
  { id: 'Squirtle',   label: 'Squirtle',   targetHeight: 1.2, facingOffset: 0 },
  { id: 'Eevee',      label: 'Eevee',      targetHeight: 1.0, facingOffset: 0 },
  // ── Legendary / Rare ─────────────────────────────────────────────────────────
  { id: 'Mew',        label: 'Mew',        targetHeight: 1.0, facingOffset: 0 },
  { id: 'Snorlax',    label: 'Snorlax',    targetHeight: 1.4, facingOffset: 0 },
  // ── Classic Pokémon ──────────────────────────────────────────────────────────
  { id: 'Haunter',    label: 'Haunter',    targetHeight: 1.2, facingOffset: 0 },
  { id: 'Jigglypuff', label: 'Jigglypuff', targetHeight: 1.0, facingOffset: 0 },
  { id: 'Magikarp',   label: 'Magikarp',   targetHeight: 1.0, facingOffset: 0 },
  { id: 'Oddish',     label: 'Oddish',     targetHeight: 1.0, facingOffset: 0 },
  { id: 'Poliwag',    label: 'Poliwag',    targetHeight: 1.0, facingOffset: 0 },
  { id: 'Bellsprout', label: 'Bellsprout', targetHeight: 1.2, facingOffset: 0 },
  { id: 'Magnemite',  label: 'Magnemite',  targetHeight: 1.0, facingOffset: 0 },
  { id: 'Cubone',     label: 'Cubone',     targetHeight: 1.1, facingOffset: 0 },
  { id: 'Dratini',    label: 'Dratini',    targetHeight: 1.2, facingOffset: 0 },
  { id: 'Exeggutor',  label: 'Exeggutor',  targetHeight: 1.6, facingOffset: 0 },
  { id: 'Weedle',     label: 'Weedle',     targetHeight: 0.9, facingOffset: 0 },
  { id: 'Abra',       label: 'Abra',       targetHeight: 1.2, facingOffset: 0 },
  { id: 'Diglett',    label: 'Diglett',    targetHeight: 0.8, facingOffset: 0 },
  { id: 'Porygon',    label: 'Porygon',    targetHeight: 1.1, facingOffset: 0 },
  // ── Gen II Pokémon ────────────────────────────────────────────────────────────
  { id: 'Marill',     label: 'Marill',     targetHeight: 1.0, facingOffset: 0 },
  { id: 'Sudowoodo',  label: 'Sudowoodo',  targetHeight: 1.3, facingOffset: 0 },
  { id: 'Glalie',     label: 'Glalie',     targetHeight: 1.2, facingOffset: 0 },
  // ── Items ─────────────────────────────────────────────────────────────────────
  { id: 'Pokeball',   label: 'Pokéball',   targetHeight: 0.9, facingOffset: 0, noVisitor: true },
  { id: 'PokeBall2',  label: 'Pokéball II',targetHeight: 0.9, facingOffset: 0, noVisitor: true },
  // ── People ───────────────────────────────────────────────────────────────────
...
export function getCharacterFacingOffset(modelPath) {
  const id = modelPath.split('/').pop().replace('.glb', '')
  return CHARACTERS.find(c => c.id === id)?.facingOffset ?? Math.PI
}
